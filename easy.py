...
def get_median_int(p, s, e, l):
    dates = p[(p['date']> s) & (p['date']< e) & (p['location_id']==l)] # '2019-01-09 12:00:00'
...
def median_pickup_time():
    ...
    answer = get_median_int(pickup_times, start_time, end_time, location_id_str)
